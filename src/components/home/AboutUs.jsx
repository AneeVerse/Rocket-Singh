    ...
    <section id="about" className="py-16 bg-white">
      <Container>
        <div className="flex flex-col lg:flex-row items-center lg:items-start space-y-8 lg:space-y-0 lg:space-x-12">
          ...
          {/* Right Text Section */}
          <div className="w-full lg:w-1/2 space-y-6 text-center lg:text-left lg:max-h-[500px] flex flex-col justify-center">
            <h2 className="text-4xl font-bold text-gray-800">About Us</h2>
            <p className="text-gray-600 text-lg leading-relaxed">
              At <span className="text-red-600">Rocket Singh</span>, we are dedicated to making your experience effortless. With years of industry expertise, our team of professionals provides quick, reliable assistance tailored to your needs.
            </p>
            <p className="text-gray-600 text-lg leading-relaxed">
